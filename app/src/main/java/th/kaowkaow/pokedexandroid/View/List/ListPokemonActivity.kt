...
class ListPokemonActivity : AppCompatActivity(), PokemonAdapter.OnClickListener {
    ...
    lateinit var pokemonAdater: PokemonAdapter
    ...
    private fun opserveData() {
        listPokeViewModel.callSuccessResponse.observe(this, {
            pokemonAdater.setListData(it)
        })
        listPokeViewModel.callFailResponse.observe(this, {
    ...
    private fun setAdapter() {
        pokemonAdater = PokemonAdapter()
        pokemonAdater?.setOnItemClickListerner(this)

        recyclerView.layoutManager = LinearLayoutManager(this, LinearLayoutManager.VERTICAL, false)
        recyclerView.adapter = pokemonAdater
        etSearch.addTextChangedListener(object : TextWatcher {
            ...
            override fun onTextChanged(s: CharSequence?, start: Int, before: Int, count: Int) {
                pokemonAdater.filter.filter(s.toString())
            }
